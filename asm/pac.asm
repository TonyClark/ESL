...
CodeBox(behaviour12,33)
    ...
    7 IS0       
    8 FAILFALSE 
    9 instrs.vars.PushDynamic@6a86aef4
   10 instrs.control.Grab@2f842dc0
   11 STARTCALL 
   12 APPDYNAMIC 20    0         
   13 SKIPFALSE  4         
   14 STARTCALL 
   ...
   36 SKIP       2         
   37 NULL      
   38 instrs.vars.PushDynamic@39c09f51
   39 instrs.control.Release@1ee1e16d
   40 SKIP       23        
   41 TRY        4     false     
   42 ISTERM     Time  1          [0]       
...
CodeBox(behaviour11,3)
    ...
    8 FAILFALSE 
    9 DYNAMIC    1         
   10 instrs.vars.DynamicRef@414f0d4b
   11 instrs.control.Grab@4fabd28f
   12 STARTCALL 
   13 SELF      
   ...
   26 NULL      
   27 DYNAMIC    1         
   28 instrs.vars.DynamicRef@72ace63c
   29 instrs.control.Release@63d79b8d
   30 SKIP       7         
   31 TRY        4     false     
   32 ISTERM     Time  1          [0]       
...
CodeBox(lambda116,1)
    ...
    4 SKIPFALSE  23        
    5 DYNAMIC    1         
    6 instrs.vars.DynamicRef@5a4be7e9
    7 instrs.control.Grab@4be56985
    8 STARTCALL 
    9 SELF      
   ...
   22 NULL      
   23 DYNAMIC    1         
   24 instrs.vars.DynamicRef@5eedfbc3
   25 instrs.control.Release@1391860
   26 SKIP       2         
   27 NULL      
   28 RETURN    
CodeBox(lambda147,6)
...
CodeBox(lambda140,1)
    ...
    3 IS0       
    4 SKIPFALSE  33        
    5 instrs.vars.PushDynamic@4c8c301
    6 instrs.control.Grab@64013b5c
    7 STARTCALL 
    8 APPDYNAMIC 20    0         
    9 SKIPFALSE  4         
   10 STARTCALL 
   ...
   32 SKIP       2         
   33 NULL      
   34 instrs.vars.PushDynamic@5583f7fc
   35 instrs.control.Release@1cb01f34
   36 SKIP       2         
   37 NULL      
   38 RETURN    
CodeBox(lambda98,5)

...
CodeBox(lambda55,6)
   ...
   17 SETDYNAMIC 1         
   18 POP       
   19 instrs.query.data.NewLogicalVar@698d8393
   20 SETFRAME   2         
   21 POP       
   22 FRAMEVAR   1         
   23 FRAMEVAR   2         
   ...
   29 Show(56,60,Clause($-show,4))
        ...
        14 Return()
   30 DYNAMIC    3         
   31 instrs.query.QRecons@21107c83
   32 SETDYNAMIC 3         
   33 DYNAMIC    2         
   34 instrs.query.QRecons@43929a3f
   35 SETDYNAMIC 2         
   36 FRAMEVAR   2         
   37 instrs.query.QRecons@331f4a96
   38 SETFRAME   2         
   39 FRAMEVAR   1         
   40 instrs.query.QRecons@368bc67d
   41 SETFRAME   1         
   42 FRAMEVAR   1         
...
CodeBox(behaviour2,11)
   ...
   28 SETDYNAMIC 1         
   29 POP       
   30 instrs.query.data.NewLogicalVar@14dd504b
   31 SETFRAME   3         
   32 POP       
   33 FRAMEVAR   2         
   34 FRAMEVAR   3         
   ...
   40 Show(58,62,Clause($-show,4))
        ...
        14 Return()
   41 DYNAMIC    3         
   42 instrs.query.QRecons@4349638d
   43 SETDYNAMIC 3         
   44 DYNAMIC    2         
   45 instrs.query.QRecons@acbda88
   46 SETDYNAMIC 2         
   47 FRAMEVAR   3         
   48 instrs.query.QRecons@621b5d82
   49 SETFRAME   3         
   50 FRAMEVAR   2         
   51 instrs.query.QRecons@1c3a1682
   52 SETFRAME   2         
   53 FRAMEVAR   2         
   ...
   80 CASEERROR 
   81 RETURN    
   82 instrs.vars.PushDynamic@14675b83
   83 instrs.control.Grab@40accc1d
   84 SELF      
   85 DYNAMIC    2         
   86 TERM       Loc   2         
   87 DYNAMIC    17        
   ...
   96 instrs.vars.PushDynamic@78637ec7
   97 instrs.control.Release@34a1f94f
   98 POPFRAME  
...
CodeBox(lambda44,6)
    ...
    7 instrs.vars.PushDynamic@1ab4071b
    8 instrs.vars.PushDynamic@3c5efc74
    9 instrs.control.Grab@5fa8387e
   10 STARTCALL 
   11 FRAMEVAR   4         
   12 DYNAMIC    16        
   13 REF        [Key(member)]
   ...
   33 SETDYNAMIC 17        
   34 instrs.vars.PushDynamic@64f8c945
   35 instrs.vars.PushDynamic@5e4e861e
   36 instrs.control.Release@15b87cff
   37 SKIP       15        
   38 TRY        8     false     
...
CodeBox(lambda31,4)
   ...
   55 RETURN    
CodeBox(lambda30,8)
    0 instrs.query.data.NewLogicalVar@b4dcdfe
    1 SETFRAME   1         
    2 POP       
    3 FRAMEVAR   1         
    4 DYNAMIC    13        
    ...
    7 Show(76,78,Clause($-show,1))
         ...
         5 Return()
    8 FRAMEVAR   1         
    9 instrs.query.QRecons@29dd9f33
   10 SETFRAME   1         
   11 STARTCALL 
   12 FRAMEVAR   1         
   13 LIST       0         

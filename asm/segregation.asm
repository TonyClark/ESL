...
CodeBox(behaviour12,2)
    ...
    8 TRY        28    false     
    9 ISTERM     Turn  0          [0]       
   10 instrs.vars.PushDynamic@44d54d85
   11 instrs.control.Grab@4a12bb6f
   12 DYNAMIC    2         
   13 DYNAMIC    1         
   14 DYNAMIC    3         
   15 NAMEDSEND Turn/2
   ...
   32 SKIP       2         
   33 NULL      
   34 instrs.vars.PushDynamic@4e2d26f5
   35 instrs.control.Release@b2fb154
   36 SKIP       2         
   37 CASEERROR 
   38 RETURN    
   39 NULL      
...
CodeBox(lambda205,5)
   ...
   26 RETURN    
CodeBox(lambda236,0)
    0 instrs.vars.PushDynamic@3aee7ad2
    1 instrs.control.Grab@1d53e9f4
    2 DYNAMIC    2         
    3 DYNAMIC    1         
    4 DYNAMIC    3         
    5 NAMEDSEND Turn/2
   ...
   22 SKIP       2         
   23 NULL      
   24 instrs.vars.PushDynamic@6b004e1b
   25 instrs.control.Release@4d38295e
   26 RETURN    
CodeBox(lambda204,8)
    0 FRAMEVAR   0         
    1 SETFRAME   2         

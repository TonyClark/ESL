...
CodeBox(asm/boids.asm,47)
  ...
  406 NEWDYNAMIC
  407 STARTCALL 
  408 STR        runtime.actors.Builtins
  409 STR        intToFloat
  410 INT        1         
  411 DYNAMIC    9         
  412 APPLY      3         
  ...
  414 POP       
  415 STARTCALL 
  416 STR        runtime.actors.Builtins
  417 STR        round     
  418 INT        1         
  419 DYNAMIC    9         
  420 APPLY      3         
...
CodeBox(behaviour0,1)
   ...
   10 STR        Boids     
   11 STR        stop      
   12 STR        icons/stop.png
   13 STR        stop application
   14 STR        fun236    
   15 Fun(0)
   16 REF        [Key(button)]
   17 APPLY      5         

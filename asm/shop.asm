...
CodeBox(lambda115,1)
    0 FRAMEVAR   0         
    1 instrs.vars.DynamicRef@481c4cc0
    2 instrs.control.Grab@4c23c11b
    3 REF        [Key(state)]
   ...
   27 NULL      
   28 FRAMEVAR   0         
   29 instrs.vars.DynamicRef@92146fb
   30 instrs.control.Release@12b23d46
   31 RETURN    
CodeBox(lambda179,1)
    0 FRAMEVAR   0         

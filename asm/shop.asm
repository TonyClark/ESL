...
CodeBox(lambda271,1)
    0 FRAMEVAR   0         
    1 instrs.vars.DynamicRef@72611d77
    2 instrs.control.Grab@765e97e3
    3 REF        [Key(state)]
   ...
   27 NULL      
   28 FRAMEVAR   0         
   29 instrs.vars.DynamicRef@335c174c
   30 instrs.control.Release@78d537d0
   31 RETURN    
CodeBox(lambda270,4)
    0 FRAMEVAR   0         
    1 SETFRAME   1         

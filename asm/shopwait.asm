...
CodeBox(lambda400,1)
    0 FRAMEVAR   0         
    1 instrs.vars.DynamicRef@80c82aa
    2 instrs.control.Grab@6cb7ddb
    3 REF        [Key(state)]
   ...
   27 NULL      
   28 FRAMEVAR   0         
   29 instrs.vars.DynamicRef@2f4e9da
   30 instrs.control.Release@47f677e0
   31 RETURN    
CodeBox(lambda464,1)
    0 FRAMEVAR   0         

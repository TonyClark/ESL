...
CodeBox(lambda514,6)
   ...
   21 ISTERM     State 3          [1]       
   22 TRYSET     8     [1].ref(0)
   23 SETFRAME   4     8.choose()
   24 SETFRAME   3     8.rest()  
...
CodeBox(lambda509,7)
   ...
   20 CASEERROR 
   21 RETURN    
CodeBox(lambda511,10)
    0 FRAMEVAR   2         
    1 SETFRAME   3         
    2 POP       
    3 TRY        25    true      
    4 TRYSET     7     [3]       
    5 ISTERM     Machine 5          7.choose()
    6 SETFRAME   9     7.choose().ref(0)
    7 SETFRAME   4     7.choose().ref(1)
    8 SETFRAME   6     7.choose().ref(2)
    9 SETFRAME   5     7.choose().ref(3)
   10 SETFRAME   7     7.choose().ref(4)
   11 SETFRAME   8     7.rest()  
   12 FRAMEVAR   9         
   13 FRAMEVAR   0         
   14 EQL       
   15 FAILFALSE 
...
CodeBox(lambda508,4)
    ...
    7 TRY        11    false     
    8 TRYSET     5     [1]       
    9 SETFRAME   2     5.choose()
   10 SETFRAME   3     5.rest()  
   11 STARTCALL 
   12 FRAMEVAR   2         
   13 APPDYNAMIC 11    1         
   14 STARTCALL 
...
CodeBox(lambda510,4)
    ...
    7 TRY        12    false     
    8 TRYSET     6     [1]       
    9 SETFRAME   2     6.choose()
   10 SETFRAME   3     6.rest()  
   11 STARTCALL 
   12 FRAMEVAR   2         
   13 APPDYNAMIC 9     1         
   14 SET        1         

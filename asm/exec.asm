...
CodeBox(lambda9,6)
   ...
   21 ISTERM     State 3          [1]       
   22 TRYSET     3     [1].ref(0)
   23 SETFRAME   4     3.choose()
   24 SETFRAME   3     3.rest()  
...
CodeBox(lambda6,10)
    ...
    3 TRY        25    true      
    4 TRYSET     2     [3]       
    5 ISTERM     Machine 5          2.choose()
    6 SETFRAME   9     2.choose().ref(0)
    7 SETFRAME   4     2.choose().ref(1)
    8 SETFRAME   6     2.choose().ref(2)
    9 SETFRAME   5     2.choose().ref(3)
   10 SETFRAME   7     2.choose().ref(4)
   11 SETFRAME   8     2.rest()  
   12 FRAMEVAR   9         
   13 FRAMEVAR   0         
   14 EQL       
   15 FAILFALSE 
...
CodeBox(lambda5,4)
    ...
    7 TRY        12    false     
    8 TRYSET     1     [1]       
    9 SETFRAME   2     1.choose()
   10 SETFRAME   3     1.rest()  
   11 STARTCALL 
   12 FRAMEVAR   2         
   13 APPDYNAMIC 9     1         
   14 SET        1         
...
CodeBox(lambda3,4)
    ...
    7 TRY        11    false     
    8 TRYSET     0     [1]       
    9 SETFRAME   2     0.choose()
   10 SETFRAME   3     0.rest()  
   11 STARTCALL 
   12 FRAMEVAR   2         
   13 APPDYNAMIC 11    1         
   14 STARTCALL 

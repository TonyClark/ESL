...
CodeBox(lambda60,0)
    ...
    1 RETURN    
CodeBox(lambda59,0)
    0 instrs.vars.PushDynamic@34f96877
    1 instrs.vars.PushDynamic@2701c0e8
    2 instrs.control.Grab@46a1119
    3 DYNAMIC    3         
    4 HEAD      
    5 ADD1      
    6 DYNAMIC    3         
   ...
   21 STATE      actions -1        
   22 SETDYNAMIC 9         
   23 instrs.vars.PushDynamic@75eb69fc
   24 instrs.vars.PushDynamic@aae0de6
   25 instrs.control.Release@23019adb
   26 RETURN    
CodeBox(lambda58,0)
    0 NULL      
    1 RETURN    
CodeBox(lambda57,0)
    0 instrs.vars.PushDynamic@7737a57b
    1 instrs.vars.PushDynamic@59bd96e8
    2 instrs.control.Grab@23867104
    3 DYNAMIC    3         
    4 HEAD      
    5 ADD1      
    6 DYNAMIC    3         
   ...
   21 STATE      actions -1        
   22 SETDYNAMIC 9         
   23 instrs.vars.PushDynamic@c7ee0ed
   24 instrs.vars.PushDynamic@46288064
   25 instrs.control.Release@7317549f
   26 RETURN    
CodeBox(lambda56,1)
    0 STARTCALL 
    1 STARTCALL 
   ...
   17 RETURN    
CodeBox(lambda55,0)
    0 instrs.vars.PushDynamic@630905a8
    1 instrs.vars.PushDynamic@188bf8ac
    2 instrs.control.Grab@1aa26079
    3 REF        [Key(colour)]
    4 STR        GREEN     
    5 EQL       
    6 SKIPFALSE  30        
   ...
   35 SKIP       2         
   36 NULL      
   37 instrs.vars.PushDynamic@53d86c1e
   38 instrs.vars.PushDynamic@78d70788
   39 instrs.control.Release@3f5edea6
   40 RETURN    
CodeBox(lambda54,1)
    0 FRAMEVAR   0         
    1 DYNAMIC    12        
    ...
    3 RETURN    
CodeBox(lambda53,2)
    0 instrs.vars.PushDynamic@3676c09c
    1 instrs.control.Grab@265ee2d0
    2 STARTCALL 
    3 DYNAMIC    3         
    4 REF        [Key(length)]
    5 APPLY      1         
   ...
   38 SKIP       2         
   39 FALSE     
   40 instrs.vars.PushDynamic@66755ad4
   41 instrs.control.Release@2f971352
   42 RETURN    
CodeBox(lambda52,0)
    0 instrs.vars.PushDynamic@2f65441c
    1 instrs.control.Grab@7e7c7b42
    2 DYNAMIC    3         
    3 HEAD      
    4 instrs.vars.PushDynamic@32133da3
    5 instrs.control.Release@2589b530
    6 RETURN    
CodeBox(lambda51,8)
    0 FRAMEVAR   0         
    1 NEWDYNAMIC

...
public class Segregation {
  ...
  {ESLVal _v12 = p;
        ...
        case "Coord": {ESLVal $5 = _v12.termRef(0);
          ESLVal $4 = _v12.termRef(1);
        ...
        default: return error(new ESLVal("case error at Pos(361,398)").add(ESLVal.list(_v12)));
      }
      }
    }
  });
  ...
  {ESLVal _v11 = p;
        ...
        case "Coord": {ESLVal $3 = _v11.termRef(0);
          ESLVal $2 = _v11.termRef(1);
        ...
        default: return error(new ESLVal("case error at Pos(422,459)").add(ESLVal.list(_v11)));
      }
      }
    }
  });
      ...
      return new ESLVal(new BehaviourAdapter(false,getSelf(),new ESLVal("pop")) {
          ...
          ESLVal diffCellCount = new ESLVal(new Function(new ESLVal("diffCellCount"),getSelf()) {
            ...
            {ESLVal legalCell = new ESLVal(new Function(new ESLVal("legalCell"),getSelf()) {
                      public ESLVal apply(ESLVal... $args) {
                        ESLVal _v14 = $args[0];
                    ESLVal _v13 = $args[1];
                    if(legalx.apply(_v14).and(legaly.apply(_v13)).boolVal)
                          if(popEl.apply(_v14,_v13).eql(c).boolVal)
                            return $one;
                            else
                              return $zero;
                          else
          ...
          public ESLVal handle(ESLVal $m) {{ESLVal _v7 = $m;
            ...
            case "Kill": {
              {kill.apply(getSelf());
            {{
              ESLVal _v8 = $zero.to(width);
              while(_v8.isCons()) {
                ESLVal x = _v8.headVal;
                {
                  ESLVal _v9 = $zero.to(height);
                  while(_v9.isCons()) {
                    ESLVal y = _v9.headVal;
      ...
      return new ESLVal(new BehaviourAdapter(false,getSelf(),new ESLVal("main")) {
        ...
        public ESLVal init() {
            return ((Supplier<ESLVal>)() -> { 
                ...
                return edb.ref("button").apply(new ESLVal("Segregation"),new ESLVal("stop"),new ESLVal("icons/stop.png"),new ESLVal("stop application"),new ESLVal(new Function(new ESLVal("fun14"),getSelf()) {
                    public ESLVal apply(ESLVal... $args) {

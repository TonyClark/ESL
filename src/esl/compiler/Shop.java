      ...
      return new ESLVal(new BehaviourAdapter(false,getSelf(),new ESLVal("displayB")) {
                ...
                LetRec letrec = new LetRec() {
                  ESLVal rows = new ESLVal(new Function(new ESLVal("rows"),getSelf()) {
                    ...
                    {ESLVal _v26 = cs;
                          ...
                          {ESLVal $102 = _v26.head();
                            ...
                            default: return error(new ESLVal("case error at Pos(4089,4453)"));
                          }
                          }
                        else if(_v26.isNil())
                          return ESLVal.list();
                        else return error(new ESLVal("case error at Pos(4089,4453)"));
                        }
                      }
                    });
                  ESLVal states = new ESLVal(new Function(new ESLVal("states"),getSelf()) {
                    ...
                    {ESLVal _v25 = allStates;
                          ...
                          return ESLVal.list();
                        else return error(new ESLVal("case error at Pos(4536,4798)"));
                        }
                      }
                    });
          ...
          ESLVal changeState = new ESLVal(new Function(new ESLVal("changeState"),getSelf()) {
            ...
            {ESLVal _v24 = cs;
                  ...
                  return cs;
                else return error(new ESLVal("case error at Pos(5219,5464)"));
                }
              }
            });
          ESLVal getSales = new ESLVal(new Function(new ESLVal("getSales"),getSelf()) {
            ...
            {ESLVal _v23 = cs;
                  ...
                  {ESLVal $86 = _v23.head();
                    ...
                    default: return error(new ESLVal("case error at Pos(5510,5651)"));
                  }
                  }
                else if(_v23.isNil())
                  return $zero;
                else return error(new ESLVal("case error at Pos(5510,5651)"));
                }
              }
            });
          ESLVal getWalkouts = new ESLVal(new Function(new ESLVal("getWalkouts"),getSelf()) {
            ...
            {ESLVal _v22 = cs;
                  ...
                  {ESLVal $79 = _v22.head();
                    ...
                    default: return error(new ESLVal("case error at Pos(5700,5847)"));
                  }
                  }
                else if(_v22.isNil())
                  return $zero;
                else return error(new ESLVal("case error at Pos(5700,5847)"));
                }
              }
            });
          ESLVal getEvents = new ESLVal(new Function(new ESLVal("getEvents"),getSelf()) {
            ...
            {ESLVal _v21 = cs;
                  ...
                  {ESLVal $72 = _v21.head();
                    ...
                    default: return error(new ESLVal("case error at Pos(5894,6047)"));
                  }
                  }
                else if(_v21.isNil())
                  return $zero;
                else return error(new ESLVal("case error at Pos(5894,6047)"));
                }
              }
            });
          ESLVal sale = new ESLVal(new Function(new ESLVal("sale"),getSelf()) {
            ...
            {ESLVal _v20 = _v63;
                  ...
                  return _v63;
                else return error(new ESLVal("case error at Pos(6124,6393)"));
                }
              }
            });
          ESLVal timeout = new ESLVal(new Function(new ESLVal("timeout"),getSelf()) {
            ...
            {ESLVal _v19 = _v59;
                  ...
                  return _v59;
                else return error(new ESLVal("case error at Pos(6473,6744)"));
                }
              }
            });
      ...
      return new ESLVal(new BehaviourAdapter(true,getSelf(),new ESLVal("helpMonitor")) {
          ...
          ESLVal assistantWaitingToHelp = new ESLVal(new Function(new ESLVal("assistantWaitingToHelp"),getSelf()) {
            ...
            {ESLVal _v15 = h;
                  ...
                  return $false;
                else return error(new ESLVal("case error at Pos(8796,8949)"));
                }
              }
            });
          ESLVal startHelp = new ESLVal(new Function(new ESLVal("startHelp"),getSelf()) {
            ...
            {ESLVal _v14 = h;
                ...
                else return error(new ESLVal("case error at Pos(9006,9335)"));
                }
              }
            });
          ESLVal tryToHelp = new ESLVal(new Function(new ESLVal("tryToHelp"),getSelf()) {
            ...
            {ESLVal _v13 = h;
                ...
                else return error(new ESLVal("case error at Pos(9393,9721)"));
                }
              }
            });
          ESLVal process = new ESLVal(new Function(new ESLVal("process"),getSelf()) {
            ...
            {ESLVal _v12 = s;
                  ...
                  case "WaitingToHelp": {ESLVal $38 = $35.termRef(0);
                    ...
                    default: return error(new ESLVal("case error at Pos(9757,10507)"));
                  }
                  }
                else if(_v12.isNil())
                  return s;
                else return error(new ESLVal("case error at Pos(9757,10507)"));
                }
              }
            });
      ...
      return new ESLVal(new BehaviourAdapter(true,getSelf(),new ESLVal("tillMonitor")) {
          ...
          ESLVal findBusyTill = new ESLVal(new Function(new ESLVal("findBusyTill"),getSelf()) {
            ...
            {ESLVal _v9 = s;
                  ...
                  return $zero.sub($one);
                else return error(new ESLVal("case error at Pos(11152,11302)"));
                }
              }
            });
          ESLVal findServicedTill = new ESLVal(new Function(new ESLVal("findServicedTill"),getSelf()) {
            ...
            {ESLVal _v8 = s;
                  ...
                  return $zero.sub($one);
                else return error(new ESLVal("case error at Pos(11346,11501)"));
                }
              }
            });
          ESLVal startServe = new ESLVal(new Function(new ESLVal("startServe"),getSelf()) {
            ...
            {ESLVal _v7 = h;
                ...
                else return error(new ESLVal("case error at Pos(11571,11962)"));
                }
              }
            });
          ESLVal tryToServe = new ESLVal(new Function(new ESLVal("tryToServe"),getSelf()) {
            ...
            {ESLVal _v6 = h;
                ...
                else return error(new ESLVal("case error at Pos(12033,12404)"));
                }
              }
            });
          ESLVal process = new ESLVal(new Function(new ESLVal("process"),getSelf()) {
            ...
            {ESLVal _v5 = s;
                  ...
                  case "TillReady": {ESLVal $5 = $1.termRef(0);
                    ...
                    default: return error(new ESLVal("case error at Pos(12443,13371)"));
                  }
                  }
                else if(_v5.isNil())
                  return s;
                else return error(new ESLVal("case error at Pos(12443,13371)"));
                }
              }
            });

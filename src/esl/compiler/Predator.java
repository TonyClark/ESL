...
public class Predator {
																							...
																							return new ESLVal(new BehaviourAdapter(false, getSelf(), new ESLVal("predator")) {
																																												...
																																												public ESLVal get(String name) {
																																													...
																																													case "getId":
																																														return getId;
																																													default:
																																														throw new Error("ref illegal " + self + "." + name);
																																													}
																																												}
																																											...
																																											ESLVal generate = new ESLVal(new Function(new ESLVal("generate"), getSelf()) {
																																																																public ESLVal apply(ESLVal... $args) {
																																																																	...
																																																																	if (n.eql($zero).boolVal)
																																																																		...
																																																																		if (member.apply(new ESLVal("Point", x, y),
																																																																		    ps).boolVal)
																																																																			return generate.apply(ps, n);
																																																																		else
																																																																			return generate
																																																																			    .apply(ps.cons(new ESLVal("Point", x, y)),
																																																																			        n.sub($one))
																																																																			    .cons(new ESLVal("Point", x, y));
																																																																	}
																																																																}
																																																															});
	...
	private static ESLVal	pointX						= new ESLVal(new Function(new ESLVal("pointX"), getSelf()) {
																						public ESLVal apply(ESLVal... $args) {
																							...
																							default:
																								return error(new ESLVal("case error at Pos(5369,5406)"));
																							}
																						}
																					});
	private static ESLVal	pointY						= new ESLVal(new Function(new ESLVal("pointY"), getSelf()) {
																						public ESLVal apply(ESLVal... $args) {
																							...
																							default:
																								return error(new ESLVal("case error at Pos(5431,5468)"));
																							}
																						}
																					});
	...
	private static ESLVal	predators					= new ESLVal(new Function(new ESLVal("qual"), getSelf()) {
																						public ESLVal apply(ESLVal... $args) {
																							ESLVal $qualArg = $args[0];
																							{
																								...
																								return ESLVal.list(ESLVal
																								    .list(newActor(predator, new ESLVal(new Actor()), p, pointX.apply(nth.apply(points, p)), pointY.apply(nth.apply(points, p)))));
																							}
																						}
																					}).map($zero.to(numOfPredators)).flatten().flatten();
	private static ESLVal	thePrey						= newActor(prey, new ESLVal(new Actor()), pointX.apply(nth.apply(points, numOfPredators)),
	    pointY.apply(nth.apply(points, numOfPredators)));
																																												...
																																												public void handleTime(ESLVal $t) {
																																													{
																																														...
																																														if (stop.not().and(n.less(limit)).boolVal) {
																																															...
																																															if ($true.boolVal) {
																																																print.apply(new ESLVal("Messages: ")
																																																    .add(length.apply(messages).add(new ESLVal(" ").add(messages))));
																																																stopAll.apply();
																																															} else {
																																															}
																																														}

...
public class Philosophers {
  ...
  {ESLVal _v19 = p;
        ...
        default: return error(new ESLVal("case error at Pos(4417,4460)"));
      }
      }
    }
  });
  ...
  {ESLVal _v18 = p;
        ...
        default: return error(new ESLVal("case error at Pos(4541,4584)"));
      }
      }
    }
  });
  ...
  {ESLVal _v17 = _v33;
        ...
        return ESLVal.list();
      else return error(new ESLVal("case error at Pos(4710,4801)"));
      }
    }
  });
  ...
  {ESLVal _v16 = s;
        ...
        default: return error(new ESLVal("case error at Pos(4837,4993)"));
      }
      }
    }
  });
  ...
  {ESLVal _v15 = holds;
        ...
        return ESLVal.list();
      else return error(new ESLVal("case error at Pos(7223,7374)"));
      }
    }
  });
  ...
  {ESLVal _v14 = _v30;
        ...
        return ESLVal.list();
      else return error(new ESLVal("case error at Pos(7510,7636)"));
      }
    }
  });
  ...
  {ESLVal _v13 = edb.ref("math").ref("circlePos").apply(centreX,centreY,chopstickRadius,new ESLVal(360).div(numberOfPhilosophers).mul(i));
        ...
        default: return error(new ESLVal("case error at Pos(7873,8115)"));
      }
      }
    }
  });
  ...
  {ESLVal _v12 = _v25;
        ...
        case "Release": {ESLVal $19 = $17.termRef(0);
          ...
          default: return error(new ESLVal("case error at Pos(8292,8505)"));
        }
        }
      else if(_v12.isNil())
        return ESLVal.list(new ESLVal("Snapshot",$nil,chopsticks));
      else return error(new ESLVal("case error at Pos(8292,8505)"));
      }
    }
  });
  ...
  {ESLVal _v11 = fs;
        ...
        {ESLVal $13 = _v11.head();
          ...
          default: return error(new ESLVal("case error at Pos(8685,8842)"));
        }
        }
      else if(_v11.isNil())
        return error(new ESLVal("case error at Pos(8685,8842)"));
      else return error(new ESLVal("case error at Pos(8685,8842)"));
      }
    }
  });
  ...
  {ESLVal _v10 = fs;
        ...
        {ESLVal $9 = _v10.head();
          ...
          default: return error(new ESLVal("case error at Pos(9002,9138)"));
        }
        }
      else if(_v10.isNil())
        return error(new ESLVal("case error at Pos(9002,9138)"));
      else return error(new ESLVal("case error at Pos(9002,9138)"));
      }
    }
  });
  ...
  {ESLVal _v9 = holds;
        ...
        {ESLVal $5 = _v9.head();
          ...
          default: return error(new ESLVal("case error at Pos(9268,9445)"));
        }
        }
      else if(_v9.isNil())
        return ESLVal.list(new ESLVal("Holds",p,ESLVal.list(c)));
      else return error(new ESLVal("case error at Pos(9268,9445)"));
      }
    }
  });
  ...
  {ESLVal _v8 = holds;
        ...
        {ESLVal $1 = _v8.head();
          ...
          default: return error(new ESLVal("case error at Pos(9546,9747)"));
        }
        }
      else if(_v8.isNil())
        return holds;
      else return error(new ESLVal("case error at Pos(9546,9747)"));
      }
    }
  });

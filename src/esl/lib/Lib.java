...
public class Lib {
	...
	public static abstract class SerializableFunction<T, R> implements java.util.function.Function<T, R>, Serializable {
		public SerializableFunction() {
		}
	}

	public static abstract class SerializableSupplier<T> implements java.util.function.Supplier<T>, Serializable {
	...
	public static ESLVal replaceNth(ESLVal list, ESLVal index, ESLVal v) {
		int i = index.intVal;
	...
	public static ESLVal replaceNth = new ESLVal(new Function(new ESLVal("replaceNth"), null) {
		public ESLVal apply(ESLVal... args) {
			return replaceNth(args[0], args[1], args[2]);
		}
	});

	public static ESLVal member(ESLVal x, ESLVal l) {
		return l.member(x);
	}
	...
	public static ESLVal sum(ESLVal l) {
		int i = 0;
		while(!l.isNil()) {
			i += l.head().intVal;
			l = l.tail();
	...
	public static ESLVal remove(ESLVal x, ESLVal l) {
		return l.remove(x);
	}
	...
	public static ESLVal removeAll = new ESLVal(new Function(new ESLVal("removeAll"), null) {
		public ESLVal apply(ESLVal... args) {
			...
			ESLVal l = args[1];
			return removeAll(removables, l);
		}
	});

	public static ESLVal exists(ESLVal p, ESLVal l) {
		switch (l.state) {
		case NIL:
			return $false;
		case CONS:
	...
	public static ESLVal filter(ESLVal p, ESLVal lin) {
		ESLVal lout = $nil;
		while (!lin.isNil()) {
	...
	public static ESLVal forall(ESLVal p, ESLVal l) {
	...
	public static ESLVal reject(ESLVal p, ESLVal l) {
		...
		case CONS:
			if (p.apply(l.headVal).boolVal)
				return reject.apply(p, l.tailVal);
			else
				return new ESLVal(l.headVal, reject.apply(p, l.tailVal));
		case NIL:
			return l;
		default:
	...
	public static ESLVal reject = new ESLVal(new Function(new ESLVal("reject"), null) {
		public ESLVal apply(ESLVal... args) {
			ESLVal pred = args[0];
			ESLVal l = args[1];
			return reject(pred, l);
		}
	});

	public static ESLVal map(ESLVal pred, ESLVal l) {
		switch (l.state) {
		case CONS:
			return new ESLVal(pred.apply(l.headVal), map.apply(pred, l.tailVal));
		case NIL:
			return l;
		default:
	...
	public static ESLVal nth(ESLVal list, ESLVal index) {
		int i = index.intVal;
		while (i != 0 && list.state == ValState.CONS) {
			i--;
			list = list.tailVal;
	...
	public static ESLVal take(ESLVal list, ESLVal index) {
		int i = index.intVal;
		return list.take(i);
	}
	...
	public static ESLVal drop(ESLVal list, ESLVal index) {
		int i = index.intVal;
		return list.drop(i);
	}
	...
	public static ESLVal dropWhile(ESLVal pred, ESLVal list) {
		if (list.isNil()) {
			return list;
		} else {
	...
	public static ESLVal dropWhile = new ESLVal(new Function(new ESLVal("dropWhile"), null) {
		public ESLVal apply(ESLVal... args) {
			ESLVal pred = args[0];
			ESLVal list = args[1];
			return dropWhile(pred, list);
		}
	});

	public static ESLVal subst(ESLVal new_, ESLVal old, ESLVal list) {
		if (list.isNil()) {
			return list;
		} else {
	...
	public static ESLVal subst = new ESLVal(new Function(new ESLVal("subst"), null) {
		public ESLVal apply(ESLVal... args) {
			...
			ESLVal old = args[1];
			ESLVal list = args[2];
			return subst(new_, old, list);
		}
	});

	public static ESLVal takeWhile(ESLVal pred, ESLVal list) {
		if (list.isNil()) {
			return list;
		} else {
			if (pred.apply(list.headVal).boolVal) {
	...
	public static ESLVal removeDups(ESLVal lin) {
		ESLVal lout = $nil;
		while (!lin.isNil()) {
	...
	public static ESLVal	removeDups		= new ESLVal(new Function(new ESLVal("removeDups"), null) {
																				public ESLVal apply(ESLVal... args) {
																					ESLVal lin = args[0];
																					return removeDups(lin);
																				}
																			});

	public static ESLVal	foldr					= new ESLVal(new Function(new ESLVal("foldr"), null) {
																				...
																				public ESLVal apply(ESLVal... args) {
																					...
																					ESLVal unit = args[2];
																					ESLVal list = args[3];
																					return foldr(map, bin, unit, list);
																				}
																			});
	...
	private static ESLVal	readWorkbook	= new ESLVal(new Function(new ESLVal("readWorkbook"), null) {

																				public ESLVal apply(ESLVal... args) {
																					String path = args[0].strVal;
																					return ExcelReader.readWorkbook(path);
																				}
																			});

	private static ESLVal	writeWorkbook	= new ESLVal(new Function(new ESLVal("writeWorkbook"), null) {

																				public ESLVal apply(ESLVal... args) {
																					String path = args[0].strVal;
																					ESLVal term = args[1];
																					return ExcelReader.writeWorkbook(path, term);
																				}
																			});
	...
	public static ESLVal indexOf(ESLVal element, ESLVal list) {
		int i = 0;
		while (!list.isNil()) {
	...
	public static ESLVal indexOf = new ESLVal(new Function(new ESLVal("IndexOf"), null) {
		public ESLVal apply(ESLVal... args) {
			...
			ESLVal list = args[1];
			return indexOf(element, list);
		}
	});

	public static ESLVal lengthFun(ESLVal l) {
		int i = 0;
	...
	public static ESLVal last(ESLVal l) {
		while (l.state == ValState.CONS) {
			ESLVal v = l.headVal;
			l = l.tailVal;
	...
	public static ESLVal butlast(ESLVal l) {
		if (l.isNil())
			return l;
	...
	public static ESLVal select1 = new ESLVal(new Function(new ESLVal("select1"), null) {
		public ESLVal apply(ESLVal... args) {
			...
			ESLVal d = args[1];
			ESLVal p = args[2];
			return select1(l, d, p);
		}
	});

	public static ESLVal select(ESLVal pred, ESLVal lIn) {
		ESLVal lOut = $nil;
		while (!lIn.isNil()) {
	...
	public static ESLVal flatten(ESLVal l) {
		return l.flatten();
	}
	...
	public static ESLVal id(ESLVal x) {
		return x;
	}
	...
	public static ESLVal head(ESLVal l) {
		return l.head();
	}
	...
	public static ESLVal tail(ESLVal l) {
		return l.tail();
	}
	...
	public static ESLVal foldr(ESLVal map, ESLVal bin, ESLVal unit, ESLVal list) {
		if (list.isNil())
			return unit;
		else
			return bin.apply(map.apply(list.head()), foldr(map, bin, unit, list.tail()));
	}

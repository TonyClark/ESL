...
public class Always extends BodyElement {
  ...
  public Always(int lineStart, int lineEnd, BodyElement[] elements) {
  ...
  public BodyElement subst(Type type, String typeName) {
    ...
    return new Always(getLineStart(), getLineEnd(), newElements);
  }
  ...
  public void compile(Vector<Instr> code, int length, Vector<String> vars, boolean isLast) {
    throw new Error("cannot compile " + this);
  }

 ...
 * @version 1.0
 */
public class Search extends JFrame implements SearchListener {
	...
	private class GoToLineAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			GoToDialog dialog = new GoToDialog(Search.this);
	...
	private class LookAndFeelAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				...
				SwingUtilities.updateComponentTreeUI(Search.this);
				if (findDialog != null) {
					findDialog.updateUI();

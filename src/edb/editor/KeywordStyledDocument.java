...
public class KeywordStyledDocument extends DefaultStyledDocument {
  ...
  private static final boolean isReservedWord(String word) {
    return (word.trim().equals("then") || word.trim().equals("grab") || word.trim().equals("act") || word.trim().equals("import") || word.trim().equals("for") || word.trim().equals("find") || word.trim().equals("do") || word.trim().equals("not") || word.trim().equals("fun") || word.trim().equals("letrec") || word.trim().equals("let") || word.trim().equals("in")
        || word.trim().equals("new") || word.trim().equals("true") || word.trim().equals("false") || word.trim().equals("case") || word.trim().equals("become") || word.trim().equals("self") || word.trim().equals("probably") || word.trim().equals("now") || word.trim().equals("null") || word.trim().equals("if") || word.trim().equals("else")
        || word.trim().equals("when") || word.trim().equals("and") || word.trim().equals("or") || word.trim().equals("try") || word.trim().equals("catch") || word.trim().equals("throw") || word.trim().equals("bag") || word.trim().equals("set") || word.trim().equals("export") || word.trim().equals("union") || word.trim().equals("where"));
  }

  private static final boolean isTypeWord(String word) {
    return (word.trim().equals("type") || word.trim().equals("unfold")  || word.trim().equals("fold")  || word.trim().equals("Void")  || word.trim().equals("Fun") || word.trim().equals("rec") || word.trim().equals("Float") || word.trim().equals("Str") || word.trim().equals("Bool") || word.trim().equals("Int") || word.trim().equals("Act") || word.trim().equals("Set") || word.trim().equals("Bag"));
  }
}